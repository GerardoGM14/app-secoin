...
function FacturasPanel({ empresaSeleccionada }) {
  ...
  const obtenerTipoArchivo = (nombre) => {
    ...
    if (nombreLower.includes("boleta")) return "boleta"
    if (nombreLower.includes("recibo")) return "recibo"
    if (nombreLower.includes("nota")) return "nota"
    return "documento"
  }
  ...
  const obtenerBadgeTipo = (tipo) => {
    switch (tipo) {
      case "factura":
        return <span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">Factura</span>
      case "boleta":
        return <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Boleta</span>
      case "recibo":
        return <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Recibo</span>
      case "nota":
        return <span className="px-2 py-1 bg-purple-100 text-purple-800 text-xs font-medium rounded-full">Nota</span>
      default:
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Panel de Facturas</h1>
            <p className="text-red-100">Gestiona las facturas y comprobantes de pago de la empresa</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="mt-6">
          ...
          <div className="relative">
            <textarea
              placeholder="Agrega un comentario sobre esta factura..."
              value={comentario}
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div className="flex flex-wrap gap-2">
              ...
              {["todos", "factura", "boleta", "recibo", "nota", "documento"].map((tipo) => (
                <button
                  key={tipo}
        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Esta empresa aún no tiene facturas subidas.</p>
            </div>
          </div>
        </motion.div>
      ) : (
      ...
      {archivos.length > 0 && (
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-red-600">
                {archivos.filter((a) => obtenerTipoArchivo(a.nombre) === "boleta").length}
              </div>
              <div className="text-sm text-red-700">Boletas</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-red-600">
            ...
            <div>
              <div className="text-2xl font-bold text-red-600">
                {archivos.filter((a) => obtenerTipoArchivo(a.nombre) === "nota").length}
              </div>
              <div className="text-sm text-red-700">Notas</div>
            </div>
          </div>
        </motion.div>
      )}
