...
function OrdenesCompraPanelEmpresa() {
  ...
  const obtenerArchivos = async (empresaId) => {
    ...
    try {
      ...
      const q = query(collection(db, "ordenesCompra"), where("empresaId", "==", empresaId))
  ...
  const obtenerTipoArchivo = (nombre) => {
    ...
    if (nombreLower.includes("solicitud") || nombreLower.includes("pedido")) return "solicitud"
    if (nombreLower.includes("autorizacion") || nombreLower.includes("aprobacion")) return "autorizacion"
    return "documento"
  }
  ...
  const obtenerBadgeTipo = (tipo) => {
    switch (tipo) {
      case "orden":
        return <span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">Orden</span>
      case "solicitud":
        return <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Solicitud</span>
      case "autorizacion":
        return (
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-red-100">Consulta y descarga tus órdenes de compra</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {["todos", "orden", "solicitud", "autorizacion", "documento"].map((tipo) => (
                <button
                  key={tipo}
            ...
            <div>
              ...
              <p className="text-gray-500">
                {busqueda || filtroTipo !== "todos"
                  ...
                  : "Aún no tienes órdenes de compra disponibles"}
              </p>
            </div>
          </div>
        </motion.div>
      ...
      {archivos.length > 0 && (
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-red-600">
                {archivos.filter((a) => obtenerTipoArchivo(a.nombre) === "solicitud").length}
              </div>
              <div className="text-sm text-red-700">Solicitudes</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-red-600">
...
export default OrdenesCompraPanelEmpresa
