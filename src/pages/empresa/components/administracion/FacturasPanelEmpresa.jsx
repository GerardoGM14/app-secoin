...
function FacturasPanelEmpresa() {
  ...
  const obtenerArchivos = async (empresaId) => {
    ...
    try {
      ...
      const q = query(collection(db, "facturas"), where("empresaId", "==", empresaId))
  ...
  const obtenerTipoArchivo = (nombre) => {
    ...
    if (nombreLower.includes("nota") || nombreLower.includes("credito") || nombreLower.includes("debito")) return "nota"
    return "documento"
  }
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-red-100">Consulta y descarga tus facturas</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {["todos", "factura", "boleta", "nota", "documento"].map((tipo) => (
                <button
                  key={tipo}
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {busqueda || filtroTipo !== "todos" ? "No se encontraron facturas" : "No hay facturas disponibles"}
              </h3>
...
export default FacturasPanelEmpresa
