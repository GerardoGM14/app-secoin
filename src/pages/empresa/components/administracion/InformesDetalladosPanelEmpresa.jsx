...
function InformesDetalladosPanelEmpresa() {
  ...
  const obtenerArchivos = async (empresaId) => {
    ...
    try {
      ...
      const q = query(collection(db, "informes_detallados"), where("empresaId", "==", empresaId))
      ...
      setError("Error al cargar los informes detallados")
    } finally {
      setCargando(false)
    }
  }
  ...
  const obtenerTipoArchivo = (nombre) => {
    ...
    if (nombreLower.includes("evaluacion") || nombreLower.includes("evaluación")) return "evaluacion"
    return "documento"
  }
  ...
  const obtenerBadgeTipo = (tipo) => {
    switch (tipo) {
      ...
      case "analisis":
        return <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Análisis</span>
      case "evaluacion":
        return (
          <span className="px-2 py-1 bg-purple-100 text-purple-800 text-xs font-medium rounded-full">Evaluación</span>
        )
      default:
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Informes Detallados</h1>
            <p className="text-red-100">Consulta y descarga tus informes detallados</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {["todos", "informe", "analisis", "evaluacion", "documento"].map((tipo) => (
                <button
                  key={tipo}
      ...
      {cargando ? (
        ...
        >
          ...
          <p className="text-gray-600">Cargando informes detallados...</p>
        </motion.div>
      ) : error ? (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {busqueda || filtroTipo !== "todos"
                  ...
                  : "No hay informes detallados disponibles"}
              </h3>
              <p className="text-gray-500">
                {busqueda || filtroTipo !== "todos"
                  ? "Intenta cambiar los filtros de búsqueda"
                  : "Aún no tienes informes detallados disponibles"}
              </p>
            </div>
          </div>
        </motion.div>
...
export default InformesDetalladosPanelEmpresa
