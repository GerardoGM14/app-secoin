...
function ActasConformidadPanelEmpresa() {
  ...
  const obtenerArchivos = async (empresaId) => {
    ...
    try {
      ...
      const q = query(collection(db, "actas_conformidad"), where("empresaId", "==", empresaId))
  ...
  const obtenerBadgeTipo = (tipo) => {
    switch (tipo) {
      ...
      case "validacion":
        return (
          <span className="px-2 py-1 bg-purple-100 text-purple-800 text-xs font-medium rounded-full">Validación</span>
        )
      default:
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Actas de Conformidad</h1>
            <p className="text-red-100">Consulta y descarga tus actas de conformidad</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {busqueda || filtroTipo !== "todos" ? "No se encontraron documentos" : "No hay actas disponibles"}
              </h3>
              <p className="text-gray-500">
                {busqueda || filtroTipo !== "todos"
                  ? "Intenta cambiar los filtros de búsqueda"
                  : "Aún no tienes actas de conformidad disponibles"}
              </p>
            </div>
          </div>
        </motion.div>
...
export default ActasConformidadPanelEmpresa
